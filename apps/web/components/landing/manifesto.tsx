...
function MarqueeColumn({
  ...
  return (
    <div className="flex flex-col gap-6 relative overflow-hidden h-[800px] max-h-[90vh]">
      <motion.div
        animate={{
...
export function Manifesto() {
  ...
  //  FIX: move these out of JSX
const bgOpacity1 = useTransform(smoothProgress, [0, 0.5], [0.05, 0.1]);
const bgOpacity2 = useTransform(smoothProgress, [0, 0.5], [0.03, 0.08]);
  ...
  className="absolute top-1/4 hidden lg:block text-[clamp(4rem,20vw,18rem)] font-serif italic text-emerald-500 whitespace-nowrap pointer-events-none select-none blur-[3px]"
>
  Deep Context
</motion.div>
...
<motion.div
  ...
  className="absolute bottom-1/6 hidden lg:block text-[clamp(4rem,18vw,18rem)] font-serif italic text-emerald-500 whitespace-nowrap pointer-events-none select-none blur-sm"
>
  Intelligence
</motion.div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          <span className="font-mono text-[10px] tracking-[0.4em] uppercase text-emerald-500/60">
            The New Paradigm
          </span>
          <div className="h-px w-8 bg-emerald-500/30" />
        </motion.div>
        ...
        >
          <h2 className="text-7xl md:text-[10rem] font-medium tracking-tighter text-muted-foreground/20 leading-none mb-4 select-none">
            Not Grep.
          </h2>
        ...
        >
          ...
          <div className="relative z-10 text-center space-y-6">
            <p className="text-2xl md:text-3xl font-serif italic text-foreground/60 leading-relaxed font-light">
              "Searching for strings is{" "}
              <span className="text-emerald-500/80">archaeology</span>. <br />
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://framerusercontent.com/images/r9v9v9v9v9v9v9v9v9v9v.png')`,
        }}
      />
    </section>
  );
